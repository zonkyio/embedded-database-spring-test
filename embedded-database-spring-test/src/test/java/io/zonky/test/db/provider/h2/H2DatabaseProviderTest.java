...
public class H2DatabaseProviderTest {
    ...
    public void providersWithDefaultConfigurationShouldEquals() {
        H2DatabaseProvider provider1 = new H2DatabaseProvider();
        H2DatabaseProvider provider2 = new H2DatabaseProvider();

        assertThat(provider1).isEqualTo(provider2);
    }

    private static int getPort(DataSource dataSource) throws SQLException {
        return dataSource.unwrap(H2EmbeddedDatabase.class).getPortNumber();
    }
}